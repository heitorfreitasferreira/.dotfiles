...
require("gitsigns").setup({
	...
	on_attach = function(bufnr)
		...
		-- Toggles
		map("n", "<leader>gtb", gitsigns.toggle_current_line_blame, { desc = "git [t]oggle [b]lame line" })
		map("n", "<leader>gtw", gitsigns.toggle_word_diff, { desc = "git [t]oggle [w]ord diff" })
