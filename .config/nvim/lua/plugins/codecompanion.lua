...
return {
  {
    ...
    cmd = {
      ...
      "CodeCompanionChat",
      "CodeCompanionCmd",
      "CodeCompanionOpenCodeServe",
      "CodeCompanionToggleModel",
    },
    keys = {
      { "<leader>ai", codecompanion_inline, desc = "AI Inline", mode = "n" },
      { "<leader>ai", codecompanion_inline_visual, desc = "AI Inline", mode = "x" },
      { "<leader>am", toggle_model, desc = "AI Toggle Model", mode = { "n", "x" } },
    },
    opts = {
      adapters = {
        acp = {
